...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('database_path',  default_value='~/.ros/gazebo.db',  description='Where is the map saved/loaded.'),
        ...
        DeclareLaunchArgument('rtabmap_args',   default_value='--Optimizer/Strategy 2', description='Backward compatibility, use "args" instead.'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/rtabmap/yolo/rgb',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/rtabmap/yolo/depth', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/rtabmap/yolo/camera_info',            description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/rtabmap/yolo/odom',  description='Odometry topic name.'),
